    ...
    play() {
        ...
        for (var plr in allPlayers) {
            ...
            if (index === player.index) {
                ...
                fill('black');
                textSize(30);
                text(allPlayers[plr].name, players[index - 1].x - 40, players[index - 1].y + 30);
            ...
            text('Player 2: ' + allPlayers.player2.score, 30, 90);
        }
        ...
        var ind = players[player.index - 1];
        // console.log(ind);
        ...
        if (player.index !== null) {
            ...
            for (var i = 0; i < fruitGroup.length; i++) {
                if (fruitGroup.get(i).isTouching(ind)) {
